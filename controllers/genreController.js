...
exports.genre_update_get = function(req, res, next) {
  ...
  async.parallel({
      ...
      books: function(callback) {
          ...
          // Success.
          res.render('genre_form', { title: 'Update  Genre', book_list : results.books, selected_genre : results.genre._id, genre: results.genre });
      });
...
exports.genre_update_post = [
  ...
  (req, res, next) => {
      ...
      // Create a Genre object with escaped/trimmed data and current id.
      var genre = new Genre(
      { name: req.body.name,
          _id: req.params.id
      });
